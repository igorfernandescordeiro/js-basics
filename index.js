...
// we give a number and the function will return the sum of all the multiples of 3 and 5
console.log(sumMines(10));
console.log(sumProfessors(15));

function sumMines(limit) {
    let total = 0;
