...
//MAPPING AN ARRAY
//
const numbers12 = [1, -1, 2, 3, 4, 5, 6, -3];
const numbers13 = [1, -1, 2, 3, 4, 5, 6, -3];


const items = numbers12.map(n => '<li>' + n + '</li>');
console.log(items);
...
const items1 = numbers13.map(n => {
    return {value: n};
});

console.log(items1);

// we can chaning this methods like this:

const numbers14 = [1, -1, 2, 3, 4, 5, 6, -3];

const items2 = numbers14
.filter(n => n >= 0)
.map(n => ({ value: n}))
